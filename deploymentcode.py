...
# Applying the custom styles to the elements
st.markdown('<div class="title">Diabetes Prediction</div>', unsafe_allow_html=True)
st.markdown('<div class="subheader">Predict the likelihood of diabetes based on health metrics</div>', unsafe_allow_html=True)
st.markdown('<div class="description">**Take control of your health today!** Use this tool to determine your diabetes risk based on various health indicators.</div>', unsafe_allow_html=True)
